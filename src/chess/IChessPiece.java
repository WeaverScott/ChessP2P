...
/**********************************************************************
 * A class that acts as the interface for ChessPiece.
 *
...
public interface IChessPiece {
     ...
     * move.fromColumn]} is allowed to move to location {@code [move.
     * fromRow, move.fromColumn]}.
     *
     * Note:  Pieces don't store their own location (redundant).
     * Therefore, the {@code [move.fromRow, move.fromColumn]} component
     * of {@code move} is necessary. {@code this} object must be the
